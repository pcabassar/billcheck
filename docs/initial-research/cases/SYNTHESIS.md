# Cases — cross-case synthesis

> The analytical payoff of the case corpus — patterns across
> **insurance situation × lever × outcome**, and what they imply for the build. Not gospel.
> Corpus: **31 documented cases** = 3 deep seed cases ([index.md](index.md))
...
> **highest-frequency, highest-value jobs are mundane triage**, and there's a **realistic probability**
> the true top two are:
...
- **Scope signal (input, not a decision):** build the **common triage path first**
