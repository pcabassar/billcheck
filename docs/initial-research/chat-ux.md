# Chat UX (chat-first, with inline interactive UI)

> **⚠ HALF-BAKED BRAINSTORMED IDEAS — not a plan, just possibilities.** Informed by mid-2026 UX research (see "Research basis"). _2026-06-17._
...
- **"Looks correct — OK to pay."** Verdict card (✅) + the amounts panel showing the reconciliation
  ...
  process payment — we give permission + the breakdown.)
