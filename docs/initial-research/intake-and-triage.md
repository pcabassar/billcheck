# Intake & triage (the center of gravity)

> **⚠ HALF-BAKED BRAINSTORMED IDEAS — not a plan, just possibilities.** Grounded in [the case synthesis](cases/SYNTHESIS.md). _2026-06-17._
...
**eval triage with special weight on the false-OK rate**.
