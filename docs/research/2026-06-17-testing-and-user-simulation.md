...
> **Status: INPUT (V0.1).** How to test our agent by **simulating users** and "learn 100-at-a-time."
> Feeds [../v0.1-design/07-eval-and-safety.md](../v0.1-design/07-eval-and-safety.md). Especially load-bearing
> under the **pure-greenfield** decision (we're rebuilding the engine/safety logic → testing is what
> guarantees correctness). Entry: [../START-HERE.md](../START-HERE.md). _2026-06-17. Sourcing caveat:
...
2. **Persona population — DERIVE FROM OUR TAXONOMY** (don't free-form). Sweep the dimensions
   [SYNTHESIS](../v0.1-cases/SYNTHESIS.md) proves load-bearing: **insurance situation** (7 values + FI-vs-
