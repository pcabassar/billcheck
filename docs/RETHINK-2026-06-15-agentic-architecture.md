...
> **Status: LEADING (V0.1) — foundational thesis, NOT gospel.** The clearest statement of the core direction (especially the §5 bright line). But it's a Jun-15 decision doc, and we've learned things since — insurance-connect / system-of-record, the problem taxonomy — so treat it as **input to the brainstorm, to be revised**, not a spec. · Map: [START-HERE.md](START-HERE.md) · _classified 2026-06-16_
