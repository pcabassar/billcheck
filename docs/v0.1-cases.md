...
> insurance-situation segments. **➜ Read the [cross-case SYNTHESIS](v0.1-cases/SYNTHESIS.md)** for
...
- [01 — Uninsured / self-pay](v0.1-cases/01-uninsured-self-pay.md) (5)
- [02 — Commercial, in-network](v0.1-cases/02-commercial-in-network.md) (5; 2.1 = 3.3)
- [03 — Commercial, out-of-network / surprise](v0.1-cases/03-out-of-network-surprise.md) (5; 3.3 = 2.1)
- [04 — Medicare (FFS + Medigap, and Advantage)](v0.1-cases/04-medicare.md) (5)
- [05 — Medicaid, dual-eligible (QMB) & coordination-of-benefits](v0.1-cases/05-medicaid-dual-cob.md) (5)
- [06 — Collections, credit & legal + claim denials → appeals](v0.1-cases/06-collections-credit-denials.md) (5; 6.2 = 1.4)
...
> **[v0.1-cases/SYNTHESIS.md](v0.1-cases/SYNTHESIS.md)** — read that for the build implications.

1. **The engine is a minority tool.** **2 of 3** seed cases never touch it (confirmed at scale: central in only ~8 of 31). V0.1 is an advisor with tools; the engine is one of them — don't over-center it.
